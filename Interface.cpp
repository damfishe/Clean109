...
//		if (isalpha(c) == 0)
//		{
//			cout << "The DROP name must only be alphabets, no spaces or symbols" << endl;
...
//		{
//			if (Valid_DROP_Input(second_part_of_command, counter_to_exit) == false)
//			{
//				second_half_error_commited = true;
//			}
//		}
...
//		{
//			if (Valid_DUMP_Input(second_part_of_command, counter_to_exit) == false)
//			{
//				second_half_error_commited = true;
//			}
//		}
